		...
		public void GetPagedTest()
		{
			...
			using (var wrapper = new ContextWrapper(this))
			{
				...
				// Fix order
				{
					...
					var1.HeatTemperatureC = 0.31631696099243917;
					var1.CoolTemperatureC = 0.020366868479348193;
					...
					var2.HeatTemperatureC = 0.96032535376042372;
					var2.CoolTemperatureC = 0.20296179466087455;
					...
					var3.HeatTemperatureC = 0.99634871398860059;
					var3.CoolTemperatureC = 0.1545063649092365;
					...
					var4.HeatTemperatureC = 0.74777703022015141;
					var4.CoolTemperatureC = 0.03660520354127754;
					...
					var5.HeatTemperatureC = 0.30730530680497425;
					var5.CoolTemperatureC = 0.92843406178449939;
		...
		public void GetWithIdTest()
		{
			...
			using (var wrapper = new ContextWrapper(this))
			{
				...
				using (var controller = new TemperatureSettingController(context, logger))
				{
					...
					var1.StartTime = DateTime.MinValue;
					var1.EndTime = DateTime.MinValue;
					var1.HeatTemperatureC = 0.12650051439483673;
					var1.CoolTemperatureC = 0.24865823902592912;
					var1.DateCreated = DateTime.MinValue;
					var1.DateModified = DateTime.MinValue;
					//var2
					var2.Id = 88;
					...
					var2.StartTime = DateTime.MinValue;
					var2.EndTime = DateTime.MinValue;
					var2.HeatTemperatureC = 0.72500163629883974;
					var2.CoolTemperatureC = 0.46901937409724082;
					var2.DateCreated = DateTime.MinValue;
					var2.DateModified = DateTime.MinValue;
					//var3
					var3.Id = 70;
					...
					var3.StartTime = DateTime.MinValue;
					var3.EndTime = DateTime.MinValue;
					var3.HeatTemperatureC = 0.89604090661557434;
					var3.CoolTemperatureC = 0.44309151612366154;
					var3.DateCreated = DateTime.MinValue;
					var3.DateModified = DateTime.MinValue;
					//Fix Order
					var order = DateTime.Now;
		...
		public void PostTest()
		{
			...
			using (var wrapper = new ContextWrapper(this))
			{
				...
				using (var controller = new TemperatureSettingController(context, logger))
				{
					...
					expected.Id = 37;
					expected.DayOfWeek = 42;
					expected.Month = 77;
					expected.IsTimeOnly = true;
					expected.StartTime = DateTime.MinValue;
					expected.EndTime = DateTime.MinValue;
					expected.HeatTemperatureC = 0.5065776917648398;
					expected.CoolTemperatureC = 0.99696244858063876;
		...
		public void PutTest()
		{
			...
			using (var wrapper = new ContextWrapper(this))
			{
				...
				using (var controller = new TemperatureSettingController(context, logger))
				{
					...
					expected = new TemperatureSetting();
					expected.Id = 39;
					expected.DayOfWeek = 20;
					expected.Month = 96;
					expected.IsTimeOnly = true;
					expected.StartTime = DateTime.MinValue;
					expected.EndTime = DateTime.MinValue;
					expected.HeatTemperatureC = 0.94702629463143007;
					expected.CoolTemperatureC = 0.67143750035736594;
					expected.DateCreated = DateTime.MinValue;
					expected.DateModified = DateTime.MinValue;
					...
					expected.StartTime = DateTime.MinValue;
					expected.EndTime = DateTime.MinValue;
					expected.HeatTemperatureC = 0.14963802283147257;
					expected.CoolTemperatureC = 0.80175105240277533;
					expected.DateCreated = DateTime.MinValue;
					expected.DateModified = DateTime.MinValue;
					putPreCall(expected, wrapper);
