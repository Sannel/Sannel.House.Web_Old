		...
		public void GetPagedTest()
		{
			...
			using (var wrapper = new ContextWrapper(this))
			{
				...
				// Fix order
				{
					...
					var1.HeatTemperatureC = 0.5632601299152058;
					var1.CoolTemperatureC = 0.28257786449164984;
					...
					var2.HeatTemperatureC = 0.15440239671357087;
					var2.CoolTemperatureC = 0.70702781235195133;
					...
					var3.HeatTemperatureC = 0.58756202253865175;
					var3.CoolTemperatureC = 0.45821573094381751;
					...
					var4.HeatTemperatureC = 0.25293178169658959;
					var4.CoolTemperatureC = 0.62248297204379133;
					...
					var5.HeatTemperatureC = 0.50832435046710278;
					var5.CoolTemperatureC = 0.748705112723962;
		...
		public void GetWithIdTest()
		{
			...
			using (var wrapper = new ContextWrapper(this))
			{
				...
				using (var controller = new TemperatureSettingController(context, logger))
				{
					...
					var1.StartTime = DateTime.MinValue;
					var1.EndTime = DateTime.MinValue;
					var1.HeatTemperatureC = 0.012690876616486756;
					var1.CoolTemperatureC = 0.35570218989425439;
					var1.DateCreated = DateTime.MinValue;
					var1.DateModified = DateTime.MinValue;
					//var2
					var2.Id = 30;
					...
					var2.StartTime = DateTime.MinValue;
					var2.EndTime = DateTime.MinValue;
					var2.HeatTemperatureC = 0.13694468659206513;
					var2.CoolTemperatureC = 0.16388485076086823;
					var2.DateCreated = DateTime.MinValue;
					var2.DateModified = DateTime.MinValue;
					//var3
					var3.Id = 66;
					...
					var3.StartTime = DateTime.MinValue;
					var3.EndTime = DateTime.MinValue;
					var3.HeatTemperatureC = 0.26151470805588861;
					var3.CoolTemperatureC = 0.31187743568414705;
					var3.DateCreated = DateTime.MinValue;
					var3.DateModified = DateTime.MinValue;
					//Fix Order
					var order = DateTime.Now;
		...
		public void PostTest()
		{
			...
			using (var wrapper = new ContextWrapper(this))
			{
				...
				using (var controller = new TemperatureSettingController(context, logger))
				{
					...
					expected.Id = 40;
					expected.DayOfWeek = 17;
					expected.Month = 33;
					expected.IsTimeOnly = true;
					expected.StartTime = DateTime.MinValue;
					expected.EndTime = DateTime.MinValue;
					expected.HeatTemperatureC = 0.89293331834158551;
					expected.CoolTemperatureC = 0.33474420259461934;
		...
		public void PutTest()
		{
			...
			using (var wrapper = new ContextWrapper(this))
			{
				...
				using (var controller = new TemperatureSettingController(context, logger))
				{
					...
					expected.StartTime = DateTime.MinValue;
					expected.EndTime = DateTime.MinValue;
					expected.HeatTemperatureC = 0.21231067376784546;
					expected.CoolTemperatureC = 0.64663841046702042;
					expected.DateCreated = DateTime.MinValue;
					expected.DateModified = DateTime.MinValue;
					...
					expected.StartTime = DateTime.MinValue;
					expected.EndTime = DateTime.MinValue;
					expected.HeatTemperatureC = 0.17534706284075374;
					expected.CoolTemperatureC = 0.36231890523914195;
					expected.DateCreated = DateTime.MinValue;
					expected.DateModified = DateTime.MinValue;
					putPreCall(expected, wrapper);
