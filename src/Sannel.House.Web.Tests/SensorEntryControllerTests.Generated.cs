		...
		public void GetPagedTest()
		{
			...
			using (var wrapper = new ContextWrapper(this))
			{
				...
				// Fix order
				{
					...
					var1.DeviceId = 56;
					var1.Value = 0.42475034828519;
					var1.Value2 = 0.52840991016868966;
					var1.Value3 = 0.29387202080985159;
					var1.Value4 = 0.599284378159458;
					var1.Value5 = 0.65949989420338528;
					var1.Value6 = 0.514388031565765;
					var1.Value7 = 0.764981096966649;
					var1.Value8 = 0.41438419763668638;
					var1.Value9 = 0.80264474116388929;
					var1.DateCreated = DateTime.MinValue;
					// var2
					var2.Id = Guid.NewGuid();
					var2.SensorType = Sannel.House.Sensor.SensorTypes.Temperature;
					var2.DeviceId = 65;
					var2.Value = 0.0933780530902455;
					var2.Value2 = 0.14514075831749512;
					var2.Value3 = 0.28992995353878009;
					var2.Value4 = 0.6901163853193244;
					var2.Value5 = 0.54925751944503631;
					var2.Value6 = 0.066604518828263751;
					var2.Value7 = 0.60019880980262474;
					var2.Value8 = 0.84566822454597257;
					var2.Value9 = 0.641291107349699;
					var2.DateCreated = DateTime.MinValue;
					// var3
					var3.Id = Guid.NewGuid();
					var3.SensorType = Sannel.House.Sensor.SensorTypes.Temperature;
					var3.DeviceId = 75;
					var3.Value = 0.762005757895301;
					var3.Value2 = 0.76187160646630059;
					var3.Value3 = 0.28598788626770855;
					var3.Value4 = 0.78094839247919079;
					var3.Value5 = 0.43901514468668734;
					var3.Value6 = 0.61882100609076252;
					var3.Value7 = 0.43541652263860059;
					var3.Value8 = 0.2769522514552587;
					var3.Value9 = 0.47993747353550859;
					var3.DateCreated = DateTime.MinValue;
					// var4
					var4.Id = Guid.NewGuid();
					var4.SensorType = Sannel.House.Sensor.SensorTypes.Test;
					var4.DeviceId = 84;
					var4.Value = 0.43063346270035646;
					var4.Value2 = 0.37860245461510611;
					var4.Value3 = 0.28204581899663705;
					var4.Value4 = 0.87178039963905718;
					var4.Value5 = 0.32877276992833837;
					var4.Value6 = 0.17103749335326138;
					var4.Value7 = 0.27063423547457638;
					var4.Value8 = 0.70823627836454484;
					var4.Value9 = 0.31858383972131826;
					var4.DateCreated = DateTime.MinValue;
					// var5
					var5.Id = Guid.NewGuid();
					var5.SensorType = Sannel.House.Sensor.SensorTypes.Temperature;
					var5.DeviceId = 24;
					var5.Value = 0.79824915798299445;
					var5.Value2 = 0.20877623334935691;
					var5.Value3 = 0.72958949149101482;
					var5.Value4 = 0.8365102134814999;
					var5.Value5 = 0.66658709275842976;
					var5.Value6 = 0.22493838343067951;
					var5.Value7 = 0.22956864872461588;
					var5.Value8 = 0.5082714029160661;
					var5.Value9 = 0.89396073384860564;
		...
		public void GetWithIdTest()
		{
			...
			using (var wrapper = new ContextWrapper(this))
			{
				...
				using (var controller = new SensorEntryController(context, logger))
				{
					...
					var1.SensorType = Sannel.House.Sensor.SensorTypes.Temperature;
					var1.DeviceId = 21;
					var1.Value = 0.66658709275842976;
					var1.Value2 = 0.5082714029160661;
					var1.Value3 = 0.546898138032713;
					var1.Value4 = 0.34097438926853907;
					var1.Value5 = 0.96590094359866385;
					var1.Value6 = 0.151564268000221;
					var1.Value7 = 0.4496557807781062;
					var1.Value8 = 0.43586634026647841;
					var1.Value9 = 0.93959958289731271;
					var1.DateCreated = DateTime.MinValue;
					//var2
					var2.Id = Guid.NewGuid();
					var2.SensorType = Sannel.House.Sensor.SensorTypes.Test;
					var2.DeviceId = 73;
					var2.Value = 0.22493838343067951;
					var2.Value2 = 0.89396073384860564;
					var2.Value3 = 0.24043220106532434;
					var2.Value4 = 0.21767829648110937;
					var2.Value5 = 0.20383516941398158;
					var2.Value6 = 0.21524145650455795;
					var2.Value7 = 0.53570385488481442;
					var2.Value8 = 0.14874963003618161;
					var2.Value9 = 0.066318843078948017;
					var2.DateCreated = DateTime.MinValue;
					//var3
					var3.Id = Guid.NewGuid();
					var3.SensorType = Sannel.House.Sensor.SensorTypes.Temperature;
					var3.DeviceId = 83;
					var3.Value = 0.22956864872461588;
					var3.Value2 = 0.6715306982731124;
					var3.Value3 = 0.76211567444825346;
					var3.Value4 = 0.24179652391085241;
					var3.Value5 = 0.84399405859596754;
					var3.Value6 = 0.68294758847120574;
					var3.Value7 = 0.059300235034572067;
					var3.Value8 = 0.62768879003249523;
					var3.Value9 = 0.45679815088249659;
					var3.DateCreated = DateTime.MinValue;
					//Fix Order
					var order = DateTime.Now;
		...
		public void PostTest()
		{
			...
			using (var wrapper = new ContextWrapper(this))
			{
				...
				using (var controller = new SensorEntryController(context, logger))
				{
					...
					expected.DeviceId = 33;
					expected.Value = 0.46687686278804991;
					expected.Value2 = 0.82550708149816243;
					expected.Value3 = 0.72564742421994333;
					expected.Value4 = 0.92734222064136629;
					expected.Value5 = 0.55634471800008078;
					expected.Value6 = 0.77715487069317835;
					expected.Value7 = 0.064786361560591671;
					expected.Value8 = 0.93955542982535223;
					expected.Value9 = 0.73260710003441532;
